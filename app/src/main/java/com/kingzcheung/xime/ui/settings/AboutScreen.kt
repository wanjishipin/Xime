                ...
                Card(
                    ...
                    Column(
                        ...
                        Row(
                            modifier = Modifier
                                .fillMaxWidth()
                                .clickable { uriHandler.openUri("https://mp.weixin.qq.com/s/2cg7axj9V5BiyeCNNQPYQg") },
                            verticalAlignment = Alignment.CenterVertically
                        ) {
                            Icon(
                ...
                Card(
                    ...
                    Column(
                        ...
                        Row(
                            modifier = Modifier
                                .fillMaxWidth()
                                .clickable { uriHandler.openUri("https://github.com/ximeiorg/Xime") },
                            verticalAlignment = Alignment.CenterVertically
                        ) {
                            Icon(
                        ...
                        Row(
                            modifier = Modifier
                                .fillMaxWidth()
                                .clickable { uriHandler.openUri("https://github.com/wanjishipin/Xime") },
                            verticalAlignment = Alignment.CenterVertically
                        ) {
                            Icon(
                                imageVector = Icons.TwoTone.Code,
